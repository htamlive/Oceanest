...
public class CharacterShopUI : MonoBehaviour
{
    ...
    //    scrollRect.verticalNormalizedPosition = Mathf.Clamp01(1f - (itemIndex / (float)(shoppingItemDB.ItemsCount - 1)));
    //}
    ...
    //{
    //    ShoppingItem character = GameDataManager.GetSelectedItem();
    ...
    //        selectedCharacterIcon.sprite = GameDataManager.GetSelectedItem().image;
    //    }
    //}
