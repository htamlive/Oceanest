...
public class Ejector : MonoBehaviour
{
    ...
    public void Launch(Vector3 launchPower)
    {
        //Launch collectable after box explosion at the specificied launch power, multiplied by a random range.
        rb.AddForce(new Vector3(launchPower.x * Random.Range(-1f, 1f), launchPower.y * Random.Range(1f, 1.5f), launchPower.z * Random.Range(-1f, 1f)));
    }
