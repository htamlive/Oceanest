...
//{
//    static List<PlayerGamePlayData> PlayersGamePlayData;
//    static ItemsShopData itemsShopData = new();
...
//    public static int GetCoins(int playerIndex = 0)
//    {
//        return PlayersGamePlayData[playerIndex].coins;
//    }

//    public static void AddCoins(int amount, int playerIndex = 0)
//    {
//        if(PlayersGamePlayData.Count == 0)
//        {
//            Debug.Log("Reload data in AddCoins");
//            ReloadData();
...
//        Debug.Log("PlayerCount: " + playerCount + " PlayerData: " + PlayersGamePlayData.Count);
//        for (int i = 0; i < PlayersGamePlayData.Count; i++)
//        {
//            Utilities.SaveSerializedObject(GetPlayerDataFileName(i, playerCount), PlayersGamePlayData[i]);
...
//    {
//        CompositeGameData gameData = SteganographyScreenshot.LoadData();
//        if(gameData == null)
//        {
//            return false;
//        }
//        PlayersGamePlayData = gameData.m_Players;
//        itemsShopData = gameData.itemsShopData;
//        inventoryData = gameData.inventoryData;
//        storageInventoryData = gameData.storageInventoryData;
//        playerPositionOnGrid = gameData.playerPositionOnGrid;
//        currentSceneName = gameData.currentSceneName;

//        Debug.Log("Load steno currentSceneName: " + currentSceneName);

//        PlayerPrefs.SetInt("PlayerCount", PlayersGamePlayData.Count);
