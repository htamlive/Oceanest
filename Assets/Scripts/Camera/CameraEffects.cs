...
public class CameraEffects : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Inform the player what CameraEffect it should be controlling, no matter what
        //we are on.
        //NewPlayer.Instance.cameraEffects = this;
        //PlayerControl.Instance.cameraEffects = this;
       
        //foreach(PlayerControl player in PlayerControl.Instances)
        //{
        //    if(player != null)
        //    {
        //        player.SetCameraEffects(this);
        //    }
        ...
        //virtualCamera.Follow = PlayerControl.Instance.transform;
    }
    ...
    void Update()
    {
        ...
        {
            Debug.Log("CameraEffects: MultiChannelPerlin is null");
        } else
        {
